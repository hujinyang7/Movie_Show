...
from .views.video import (ExternaVideo,VideoSubView,VideoStarView,StarDelete,SubDelete,VideoUpdata,VideoUpdateStats)
...
urlpatterns = [
    ...
    path('video/update/<int:video_id>',VideoUpdata.as_view(),name='video_update'),
    path('video/update/status/<int:video_id>',VideoUpdateStats.as_view(),name='video_update_status')
]
