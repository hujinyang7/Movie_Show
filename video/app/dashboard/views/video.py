...
class VideoSubView(View):
    TEMPLATE = 'templates/dashboard/video/video_sub.html'
...
class VideoUpdata(View):
    TEMPLATE = 'templates/dashboard/video/video_update.html'
